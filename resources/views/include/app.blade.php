            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sideBarli adminJobsSideA">
                            <a href="{{ route('adminJobs') }}" class="nav-link ">
                                <i data-feather="briefcase"></i>
                                <span> Jobs </span>
                            </a>
                        </li>
                        <li class="sideBarli adminCompaniesSideA">
                            <a href="{{ route('adminCompanies') }}" class="nav-link ">
                                <i data-feather="building"></i>
                                <span> Entreprises </span>
                            </a>
                        </li>
                        <li class="sideBarli moderationAuditLogsSideA">
                            <a href="{{ route('moderationAuditLogs') }}" class="nav-link ">
