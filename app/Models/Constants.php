...
final class Constants
{
    ...
    const notificationTypeMentionInPost = 11;
    const notificationTypeMentionInComment = 12;
    const notificationTypeMentionInReelComment = 13;
    const notificationTypeMentionInReel = 14;
    const notificationTypeRepost = 15;
